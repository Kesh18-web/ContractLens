...
class Settings(BaseSettings):
    ...
    # BigQuery settings
    BIGQUERY_DATASET: str = Field(default="contractlens", description="BigQuery dataset")
    BIGQUERY_TABLE: str = Field(default="events", description="BigQuery events table")
    
    # Pub/Sub settings
    PUBSUB_TOPIC: str = Field(default="contractlens-events", description="Pub/Sub topic")
