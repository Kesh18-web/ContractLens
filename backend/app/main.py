...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    logger.info("Starting ContractLens API server...")
    ...
    logger.info("Initializing PipelineOrchestrator and clearing Document AI cache...")
    from app.services.pipeline_orchestrator import DocumentOrchestrator
    ...
    logger.info("Shutting down ContractLens API server...")
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="AI-powered legal contract analysis — plain-language summaries, risk assessment, and intelligent Q&A",
        version="0.1.0",
